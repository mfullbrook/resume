...
export const aboutMe: AboutMe[] = [
  {
    ...
    content: "Values innovation, promotes work-life balance, and encourages continuous learning. I thrive in environments that embrace new technologies and foster collaboration."
  },
  {
    headline: "I'm interested in roles...",
    content: "Strong technical skills in full-stack development, including frontend and backend technologies. Proficient in JavaScript, TypeScript, React, Node.js, and related tools and frameworks. Experienced in building scalable and maintainable applications using modern web technologies."
  },
  {
    headline: "Outside of work I...",
    content: "Passionate about crafting user-centric, responsive, and high-performance web applications. Committed to staying current with industry trends and best practices. A team player with a proven track record of delivering innovative solutions."
  },
  {
    headline: "I'm currently building...",
    content: "I enjoy playing video games, exploring new restaurants, and engaging in outdoor activities. I also love to learn new languages and try new cuisines."
  },
]